<template>
  <div id="app">
    <b-container fluid>
      <h3 class="text-center">Lesson 8 of 20</h3>
    ...
    <b-container fluid>
      <b-row>
        ...
        <b-col class="col-md-3 d-flex align-items-stretch">
            ...
            <b-card header="Lesson 8"
                header-tag="header"
                title="Multiplying Numbers in Variables">
...
<div>
  <b-modal v-model ="showLessonDetails" hide-footer title="Codemoji JavaScript">
      <div class="d-block text-center">
        <h3>Lesson 8: Multiply Numbers in Variables</h3>
      </div>
  ...
  methods: {
    ...
    checkAnswer() {
      ...
      if(myAnswer.length> 17) {
        this.errorMessage = "Looks like you missed a few things. Make sure your code looks like this: var meatPizza = 4*2;"
